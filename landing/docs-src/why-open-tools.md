---
title: The model should be the replaceable part
description: Don't let the model vendor own the accumulated work around the model.
nav: The replaceable part
order: 32
---
